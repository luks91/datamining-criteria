...
class JungEdgeBetweennessClusterer extends AbstractJungClusterer {

	public JungEdgeBetweennessClusterer(ClusteredDatasetAdaptable<Collection<Set<Node>>> clusteringAdapter) {
	...
	public ClusteredDataset performClustering(String filePath, int vertexAmount)
		...
		try {
			...
			EdgeBetweennessClusterer<Node, Edge> clusterer = new EdgeBetweennessClusterer<>(1);

			return mClusteringAdapter.adapt(
					clusterer.transform(inputGraph),
	...
	public String getDescription() {
		return "Jung Edge Betweenness Clusterer";
	}
}
